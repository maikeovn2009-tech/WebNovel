...
const DEFAULT_STORIES = [
  {id:1,title:"Mùa Hè Không Tên",genres:["Xuyên Không/Trùng Sinh"],type:"Oneshot",status:"done",hplus:false,
   desc:"Câu chuyện về hai người trẻ gặp nhau trong một mùa hè ngắn ngủi.",
   cover:{bg:"linear-gradient(135deg,#F59E0B,#D97706)",emoji:"M"},
   chapters:[{title:"Buổi chiều đầu tiên",content:"<p>Hà gặp Minh vào một buổi chiều tháng Sáu, khi cơn mưa đầu mùa còn chưa kịp tan.</p><p>\"Xin lỗi, chỗ này còn trống không?\" Một anh chàng đứng trước mặt, tóc ướt một nửa, nụ cười hơi ngại ngùng.</p><p>\"Được,\" cô nói.</p>"}]},
  {id:2,title:"Thiên Đạo Ngược Chiều",genres:["Tu Tiên"],type:"Truyện Dài",status:"ongoing",hplus:false,
   ...
   chapters:[{title:"Phế vật thức tỉnh",content:"<p>Không ai ngờ Lâm Phong sẽ sống qua đêm đó.</p><p>Nhưng khi hắn mở mắt ra, thứ đầu tiên hắn thấy là một biển ký ức không thuộc về mình.</p>"}]},
  {id:3,title:"Mưa Rơi Ở Thành Phố Người",genres:["Boy Love","Ngôn Tình"],type:"Truyện Dài",status:"ongoing",hplus:false,
   ...
   chapters:[{title:"Tầng ba, căn 301",content:"<p>Kiên dọn đến căn 301 vào một sáng thứ Tư, khi trời Sài Gòn đang chuẩn bị đổ mưa.</p><p>Đến chuyến thứ tư, có người ra mở cửa căn 302 và nhìn hắn không nói gì.</p>"}]}
];
